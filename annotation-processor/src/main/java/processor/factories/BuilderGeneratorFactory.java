...
public class BuilderGeneratorFactory {
  ...
  public BuilderGenerator forElement(Element annotatedElement, ClassName generatedDtoClass) {
    ...
    return switch (modelAnnotation.type()) {
      case FULL_MODEL -> new ModelBuilderGenerator(targetClass, compileUtils, generatedDtoClass);
      case DTO_MODEL -> new ModelDtoBuilderGenerator(targetClass, compileUtils);
    };
  }
}
